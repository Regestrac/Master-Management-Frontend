...
import { Target, CheckSquare, BarChart3, Clock, Users, Zap, Shield, Star, ArrowRight, Menu, X } from 'lucide-react';
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex justify-between items-center h-16'>
            ...
            <div className='hidden md:flex items-center space-x-4'>
              <Link to='/auth/login' className='text-gray-600 hover:text-gray-900 transition-colors font-medium'>
                Log In
              </Link>
              <Link to='/auth/signup' className='bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-2 rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-200 font-medium'>
                Sign Up Free
              </Link>
            </div>
            ...
            <div id='mobile-menu' className='md:hidden border-t border-gray-200 py-4' role='navigation' aria-label='Mobile navigation menu'>
              <div className='flex flex-col space-y-4'>
                ...
                <div className='pt-4 border-t border-gray-200 flex flex-col space-y-2'>
                  <Link to='/auth/login' className='text-gray-600 hover:text-gray-900 transition-colors font-medium text-left'>
                    Log In
                  </Link>
                  <Link to='/auth/signup' className='bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-2 rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-200 font-medium'>
                    Sign Up Free
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <div className='flex flex-col sm:flex-row gap-4'>
                <Link to='/auth/signup' className='bg-gradient-to-r from-purple-500 to-pink-500 text-white px-8 py-4 rounded-xl hover:from-purple-600 hover:to-pink-600 transition-all duration-200 font-semibold flex items-center justify-center group'>
                  Start Free Trial
      ...
      <section className='py-20 bg-gradient-to-r from-gray-900 to-purple-900'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            <Link to='/auth/signup' className='bg-gradient-to-r from-purple-500 to-pink-500 text-white px-8 py-4 rounded-xl hover:from-purple-600 hover:to-pink-600 transition-all duration-200 font-semibold'>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center'>
            ...
            <div className='flex space-x-6 mt-4 md:mt-0'>
              ...
              <Link to='https://github.com/Regestrac/Master-Management-Frontend' target='_blank' className='text-gray-400 hover:text-white transition-colors'>
                <span className='sr-only'>GitHub Frontend</span>
                <svg className='w-5 h-5' fill='currentColor' viewBox='0 0 24 24'>
                ...
                <span className='ms-1 text-xs'>FE</span>
              </Link>
              <Link to='https://github.com/Regestrac/Master-Management-API' target='_blank' className='text-gray-400 hover:text-white transition-colors'>
                <span className='sr-only'>GitHub Backend</span>
                <svg className='w-5 h-5' fill='currentColor' viewBox='0 0 24 24'>
                  <path d='M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z' />
                </svg>
                <span className='ms-1 text-xs'>BE</span>
              </Link>
              {/* <a href='#' className='text-gray-400 hover:text-white transition-colors'>
