    ...
    <div className={clsx('rounded-xl p-6 border shadow-sm', darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200')}>
      ...
      <div className='space-y-6'>
        ...
        <div>
          ...
          <div className='space-y-4'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <button className={clsx('flex flex-col items-center p-4 border border-blue-500 text-blue-500 rounded-lg transition-colors', darkMode ? 'hover:bg-blue-900/20' : 'hover:bg-blue-50')}>
                <svg className='w-8 h-8 mb-2' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' />
                </svg>
                <span className='text-sm font-medium'>Export Logs</span>
              </button>
              <button className={clsx('flex flex-col items-center p-4 border border-orange-500 text-orange-500 rounded-lg transition-colors', darkMode ? 'hover:bg-orange-900/20' : 'hover:bg-orange-50')}>
                <svg className='w-8 h-8 mb-2' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
        ...
        <div>
          ...
          <div className='space-y-4'>
            <div className={clsx('p-4 rounded-lg border-2 border-dashed', darkMode ? 'border-gray-600' : 'border-gray-300')}>
        ...
        <div>
          ...
          <div className={clsx('p-4 rounded-lg border-2 border-red-500', darkMode ? 'bg-red-900/10' : 'bg-red-50')}>
            <div className='space-y-4'>
              <div className='flex items-center justify-between space-x-3 mb-3'>
                <div>
                  ...
                  <p className={clsx('text-sm mb-3', darkMode ? 'text-red-200/70' : 'text-gray-600')}>
