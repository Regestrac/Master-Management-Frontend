...
import { AlignLeft, Bold, Edit3, Italic, Link2, List, Plus, Save, Type, Underline } from 'lucide-react';
import { useProfileStore } from 'stores/profileStore';
import { useTaskStore } from 'stores/taskStore';

import StickyNoteCanvasDiv from './StickyNoteCanvasDiv';

const TaskNotes = () => {
  const [adNewNote, setAddNewNote] = useState(false);
    ...
    <div className='space-y-6'>
      ...
      <div className={`rounded-xl border transition-colors ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
        <div className='p-6 border-b border-gray-200 dark:border-gray-700'>
          <div className='flex items-center justify-between'>
            ...
            <button
              onClick={() => {
                setAddNewNote(!adNewNote);
              }}
              className='flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors bg-purple-500 hover:bg-purple-600 text-white'
            >
          ...
          <div className='mt-2'>
            {adNewNote ? (
              <div className='w-full h-[100vw] bg-blue-500/40'>
                <StickyNoteCanvasDiv />
              </div>
            ) : null}
          </div>
      ...
      <div className={`rounded-xl border transition-colors ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
        <div className='p-6 border-b border-gray-200 dark:border-gray-700'>
          ...
          <div className='mt-2'>
            {adNewNote ? (
              <div className='w-full h-[50vw] bg-blue-500/40 overflow-scroll'>
                {/* <StickyNoteDemo /> */}
              </div>
            ) : null}
          </div>
